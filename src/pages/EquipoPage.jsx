function EquipoPage() {
  ...
  return (
    <section className="max-w-5xl mx-auto space-y-4 min-h-full flex flex-col justify-center md:pt-10 md:pb-7">
      ...
      <p className="text-sm md:text-base text-slate-600">
        ...
        desarrollo web, integrando tecnologías modernas para ofrecer una
        plataforma robusta, precisa y orientada al análisis.
      </p>
